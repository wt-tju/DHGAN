...
#     e = -poincare.distance(src_emb, dis_emb)
#     return {'e': e}
    return {'z':edges.src['ft_src'],'e':edges.data['a']}

def reduce_func(nodes):
    from hyperbolic.PoincareManifold import PoincareManifold
    poincare = PoincareManifold(0, 0)
    h = poincare.exp_map_zero(torch.sum(poincare.log_map_zero(poincare.mob_scalar_multi(nodes.mailbox['z'], nodes.mailbox['e'])), dim = 1))
